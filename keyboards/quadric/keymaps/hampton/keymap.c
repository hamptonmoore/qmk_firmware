...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |LCtrl |LCtrl | LALT | LGUI |LOWER |SPACE |SPACE |Raise |RCtrl |      |      |      |
     * `-----------------------------------------------------------------------------------'
     */
    [_QWERTY] = LAYOUT_ortho_5x12( \
            ...
            KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_SPC,   RAISE,   KC_RCTL, XXXXXXX, XXXXXXX, XXXXXXX    \
            ),
    ...
    [_RAISE] = LAYOUT_ortho_5x12( \
            ...
            _______, KC_LEFT, KC_DOWN,KC_RIGHT, _______, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
            _______, _______,  KC_PRT, _______, _______, _______, _______, KC_NUHS, KC_NUBS, _______, _______, _______, \
            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
            ),
